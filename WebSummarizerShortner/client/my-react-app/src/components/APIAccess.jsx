    ...
    <div className="api-wrapper">
        ...
        {showSumSection && (
          <div>
            ...
            <p>Use the <span className={`${darkMode ? 'span-dark' : 'span-light'}`}>dotenv</span> package to load and access environment variables in your application. Here's how you can do it:<br /> python</p>
            <code>
            ...
            <ul>
              ...
              <li><span className={`${darkMode ? 'span-dark' : 'span-light'}`}>length</span>: The desired length of the summary - options are 1 (short), 2 (medium), 3 (long). (Required)</li>
              ...
              <li><span className={`${darkMode ? 'span-dark' : 'span-light'}`}>citation</span>: Additional options for citing website URLs in the chosen styles - “MLA”, “APA”, “Chicago”. These options are handed to the AI, so any citation format can be handled. (Optional)</li>
              <li><span className={`${darkMode ? 'span-dark' : 'span-light'}`}>startTime</span>: The start time for partial YouTube videos when using the Timestamp option. Enter in <strong>HH:MM</strong> format, for hours and minutes of the YouTube Video. (Required for Timestamp option for YouTube URLs)</li>
              <li><span className={`${darkMode ? 'span-dark' : 'span-light'}`}>endTime</span>: The ending time for partial YouTube videos when using the Timestamp option. Enter in <strong>HH:MM</strong> format, for hours and minutes of the YouTube Video. (Required for Timestamp option for YouTube URLs)</li>
            </ul>
            <h4>Response</h4>
            <ul>
